...
RUN apt-get update ; apt-get install neo4j=2.2.0 -y
...
WORKDIR /tmp
RUN wget -q "https://github.com/neo4j-contrib/m2/blob/master/releases/org/neo4j/neo4j-spatial/0.14-neo4j-2.2.0-M01/neo4j-spatial-0.14-neo4j-2.2.0-M01-server-plugin.zip?raw=true" -O neo4j-spatial-0.14-neo4j-2.2.0-M01-server-plugin.zip
RUN mv neo4j-spatial-0.14-neo4j-2.2.0-M01-server-plugin.zip /var/lib/neo4j/plugins/
RUN unzip /var/lib/neo4j/plugins/neo4j-spatial-0.14-neo4j-2.2.0-M01-server-plugin.zip -d /var/lib/neo4j/plugins/
